...
- [2. Discover AI](#2-discover-ai)
  - [2.1. Machine Learning](#21-machine-learning)
    - [2.1.1. Machine learning in Microsoft Azure](#211-machine-learning-in-microsoft-azure)
  - [2.2. Anomaly Detection](#22-anomaly-detection)
  - [2.3. Computer Vision](#23-computer-vision)
    - [2.3.1. Computer vision services in Microsoft Azure](#231-computer-vision-services-in-microsoft-azure)
  - [2.4. Natural Language Processing (NLP)](#24-natural-language-processing-nlp)
    - [2.4.1. Natural language processing in Microsoft Azure](#241-natural-language-processing-in-microsoft-azure)
  - [2.5. Knowledge Mining](#25-knowledge-mining)
    - [2.5.1. Azure Cognitive Search](#251-azure-cognitive-search)
  - [2.6. AI Risks](#26-ai-risks)
    - [2.6.1. Fairness and Bias Concerns](#261-fairness-and-bias-concerns)
    - [2.6.2. Accidents and Physical Safety Considerations](#262-accidents-and-physical-safety-considerations)
    - [2.6.3. Malicious Use of AI:](#263-malicious-use-of-ai)
  - [2.7. Responsible AI](#27-responsible-ai)
    - [2.7.1. Fairness](#271-fairness)
    - [2.7.2. Reliability And Safety](#272-reliability-and-safety)
    - [2.7.3. Privacy And Security](#273-privacy-and-security)
    - [2.7.4. Inclusiveness](#274-inclusiveness)
    - [2.7.5. Transparency](#275-transparency)
    - [2.7.6. Accountability](#276-accountability)
- [3. Machine Learning Tools](#3-machine-learning-tools)
  - [3.1. Automated Machine Learning](#31-automated-machine-learning)
    - [3.1.1. Azure Machine Learning workspace](#311-azure-machine-learning-workspace)
    - [3.1.2. Compute Resource Types:](#312-compute-resource-types)
    - [3.1.3. A Dataset](#313-a-dataset)
      - [3.1.3.1. Deployement](#3131-deployement)
  - [3.2. Machine Learning Designer](#32-machine-learning-designer)
    - [3.2.1. Regression Model](#321-regression-model)
    - [3.2.2. Classification Model](#322-classification-model)
    - [3.2.3. Clustering Model](#323-clustering-model)
- [4. Computer Vision](#4-computer-vision)
  - [4.1. Analyze Images](#41-analyze-images)
  - [4.2. Classify Images](#42-classify-images)
    - [4.2.1. Classification](#421-classification)
    - [4.2.2. Image classification](#422-image-classification)
    - [4.2.3. Custom Vision Service](#423-custom-vision-service)
  - [4.3. Read Text](#43-read-text)
      - [4.3.0.1. OCR API](#4301-ocr-api)
      - [4.3.0.2. The Read API](#4302-the-read-api)
  - [4.4. Detect objects in images](#44-detect-objects-in-images)
    - [4.4.1. Object Detection](#441-object-detection)
      - [4.4.1.1. Returned Information:](#4411-returned-information)
  - [4.5. Detect And analyz faces](#45-detect-and-analyz-faces)
    - [4.5.1. Face detection](#451-face-detection)
    - [4.5.2. Facial analysis](#452-facial-analysis)
    - [4.5.3. Facial recognition](#453-facial-recognition)
  - [4.6. Analyze Receipts](#46-analyze-receipts)
    - [4.6.1. Using  the Form Recognizer service](#461-using--the-form-recognizer-service)
      - [4.6.1.1. Pre-built receipt model](#4611-pre-built-receipt-model)
- [5. Natural Language Processing](#5-natural-language-processing)
  - [5.1. Text Analytics](#51-text-analytics)
    - [5.1.1. Azure Language Service](#511-azure-language-service)
      - [5.1.1.1. Language detection](#5111-language-detection)
      - [5.1.1.2. Ambiguous or mixed language content](#5112-ambiguous-or-mixed-language-content)
      - [5.1.1.3. Sentiment analysis](#5113-sentiment-analysis)
      - [5.1.1.4. Indeterminate sentiment](#5114-indeterminate-sentiment)
      - [5.1.1.5. Key phrase extraction](#5115-key-phrase-extraction)
      - [5.1.1.6. Entity recognition](#5116-entity-recognition)
- [6. Recognize and synthesize speech](#6-recognize-and-synthesize-speech)
    - [6.0.1. Speech recognition](#601-speech-recognition)
    - [6.0.2. Speech synthesis](#602-speech-synthesis)
- [7. Translation](#7-translation)
      - [7.0.0.1. what is a Literal Translation](#7001-what-is-a-literal-translation)
      - [7.0.0.2. what is a Semantic Translation](#7002-what-is-a-semantic-translation)
    - [7.0.1. Text and speech translation](#701-text-and-speech-translation)
  - [7.1. The Translator service](#71-the-translator-service)
  - [7.2. The Speech service](#72-the-speech-service)
- [8. Conversational Language Understanding](#8-conversational-language-understanding)
      - [8.0.0.1. Utterances](#8001-utterances)
      - [8.0.0.2. Entities](#8002-entities)
      - [8.0.0.3. Intents](#8003-intents)
- [9. Build A Bot](#9-build-a-bot)
    - [9.0.1. Conversational AI](#901-conversational-ai)
    - [9.0.2. A bot using Microsoft Azure](#902-a-bot-using-microsoft-azure)
      - [9.0.2.1. Language service](#9021-language-service)
      - [9.0.2.2. The Azure Bot Service](#9022-the-azure-bot-service)
- [10. Decision-Making Assistance  Anomaly Detection](#10-decision-making-assistance--anomaly-detection)
    - [10.0.1. Anomaly Detector Service](#1001-anomaly-detector-service)
      - [10.0.1.1. Functionality](#10011-functionality)
      - [10.0.1.2. Data forma](#10012-data-forma)
    - [10.0.2. Use-Case](#1002-use-case)
      - [10.0.2.1. Batch detection](#10021-batch-detection)
      - [10.0.2.2. Real-time detection](#10022-real-time-detection)
- [11. knowledge Mining](#11-knowledge-mining)
  - [11.1. Azure Cognitive Search](#111-azure-cognitive-search)
    - [11.1.1. Indexes](#1111-indexes)
      - [11.1.1.1. Index schema](#11111-index-schema)
      - [11.1.1.2. Index Attributes](#11112-index-attributes)
    - [11.1.2. Knowledge Store](#1112-knowledge-store)
---
...
### 2.1.1. Machine learning in Microsoft Azure
...
### 2.3.1. Computer vision services in Microsoft Azure
...
### 2.4.1. Natural language processing in Microsoft Azure
...
### 2.6.1. Fairness and Bias Concerns
...
### 2.6.2. Accidents and Physical Safety Considerations
...
### 3.1.1. Azure Machine Learning workspace
...
## 4.6. Analyze Receipts
### 4.6.1. Using  the Form Recognizer service
...
#### 4.6.1.1. Pre-built receipt model
- Time of transaction
- Date of transaction
...
#### 5.1.1.2. Ambiguous or mixed language content
...
#### 5.1.1.4. Indeterminate sentiment
...
# 6. Recognize and synthesize speech
**Speech recognition** - the ability to detect and interpret spoken input.
**Speech synthesis** - the ability to generate spoken output.


### 6.0.1. Speech recognition
...
#### 7.0.0.1. what is a Literal Translation
...
#### 7.0.0.2. what is a Semantic Translation
...
### 7.0.1. Text and speech translation
...
# 8. Conversational Language Understanding
...
---
# 10. Decision-Making Assistance  Anomaly Detection 
...
### 10.0.1. Anomaly Detector Service
