...
# Table Of Contents
 ...
 - [1. Discover AI](#1-discover-ai)
  - [1.1. Machine Learning](#11-machine-learning)
    - [1.1.1. Machine learning in Microsoft Azure](#111-machine-learning-in-microsoft-azure)
  - [1.2. Anomaly Detection](#12-anomaly-detection)
  - [1.3. Computer Vision](#13-computer-vision)
    - [1.3.1. Computer vision services in Microsoft Azure](#131-computer-vision-services-in-microsoft-azure)
  - [1.4. Natural Language Processing (NLP)](#14-natural-language-processing-nlp)
    - [1.4.1. Natural language processing in Microsoft Azure](#141-natural-language-processing-in-microsoft-azure)
  - [1.5. Knowledge Mining](#15-knowledge-mining)
    - [1.5.1. Azure Cognitive Search](#151-azure-cognitive-search)
  - [1.6. AI Risks](#16-ai-risks)
    - [1.6.1. Fairness and Bias Concerns](#161-fairness-and-bias-concerns)
    - [1.6.2. Accidents and Physical Safety Considerations](#162-accidents-and-physical-safety-considerations)
    - [1.6.3. Malicious Use of AI:](#163-malicious-use-of-ai)
  - [1.7. Responsible AI](#17-responsible-ai)
    - [1.7.1. Fairness](#171-fairness)
    - [1.7.2. Reliability And Safety](#172-reliability-and-safety)
    - [1.7.3. Privacy And Security](#173-privacy-and-security)
    - [1.7.4. Inclusiveness](#174-inclusiveness)
    - [1.7.5. Transparency](#175-transparency)
    - [1.7.6. Accountability](#176-accountability)
     - [2. Machine Learning Tools](#2-machine-learning-tools)
  - [2.1. Automated Machine Learning](#21-automated-machine-learning)
    - [2.1.1. Azure Machine Learning workspace](#211-azure-machine-learning-workspace)
    - [2.1.2. Compute Resource Types:](#212-compute-resource-types)
    - [2.1.3. A Dataset](#213-a-dataset)
      - [2.1.3.1. Deployement](#2131-deployement)
  - [2.2. Machine Learning Designer](#22-machine-learning-designer)
    - [2.2.1. Regression Model](#221-regression-model)
    - [2.2.2. Classification Model](#222-classification-model)
    - [2.2.3. Clustering Model](#223-clustering-model)
  - [3. Computer Vision](#3-computer-vision)
  - [3.1. Analyze Images](#31-analyze-images)
  - [3.2. Classify Images](#32-classify-images)
      - [3.2.1. Classification](#321-classification)
    - [3.2.2. Image classification](#322-image-classification)
    - [3.2.3. Custom Vision Service](#323-custom-vision-service)
    - [3.3. Read Text](#33-read-text)
      - [3.3.0.1. OCR API](#3301-ocr-api)
      - [3.3.0.2. The Read API](#3302-the-read-api)
  - [3.4. Detect objects in images](#34-detect-objects-in-images)
    - [3.4.1. Object Detection](#341-object-detection)
      - [3.4.1.1. Returned Information:](#3411-returned-information)
  - [3.5. Detect And analyz faces](#35-detect-and-analyz-faces)
    - [3.5.1. Face detection](#351-face-detection)
    - [3.5.2. Facial analysis](#352-facial-analysis)
    - [3.5.3. Facial recognition](#353-facial-recognition)
  - [3.6. Analyze Receipts](#36-analyze-receipts)
    - [3.6.1. Using  the Form Recognizer service](#361-using--the-form-recognizer-service)
      - [3.6.1.1. Pre-built receipt model](#3611-pre-built-receipt-model)
- [4. Natural Language Processing](#4-natural-language-processing)
  - [4.1. Text Analytics](#41-text-analytics)
    - [4.1.1. Azure Language Service](#411-azure-language-service)
      - [4.1.1.1. Language detection](#4111-language-detection)
      - [4.1.1.2. Ambiguous or mixed language content](#4112-ambiguous-or-mixed-language-content)
      - [4.1.1.3. Sentiment analysis](#4113-sentiment-analysis)
      - [4.1.1.4. Indeterminate sentiment](#4114-indeterminate-sentiment)
      - [4.1.1.5. Key phrase extraction](#4115-key-phrase-extraction)
      - [4.1.1.6. Entity recognition](#4116-entity-recognition)
- [5. Recognize and synthesize speech](#5-recognize-and-synthesize-speech)
    - [5.0.1. Speech recognition](#501-speech-recognition)
    - [5.0.2. Speech synthesis](#502-speech-synthesis)
  - [6. Translation](#6-translation)
- [6.1. The Translator service](#61-the-translator-service)
  - [6.2. The Speech service](#62-the-speech-service)
- [7. Conversational Language Understanding](#7-conversational-language-understanding)  
  - [8. Build A Bot](#8-build-a-bot)
  - [9. Decision-Making Assistance  Anomaly Detection](#9-decision-making-assistance--anomaly-detection)
    - [9.0.1. Anomaly Detector Service](#901-anomaly-detector-service)
      - [9.0.1.1. Functionality](#9011-functionality)
      - [9.0.1.2. Data forma](#9012-data-forma)
    - [9.0.2. Use-Case](#902-use-case)
      - [9.0.2.1. Batch detection](#9021-batch-detection)
      - [9.0.2.2. Real-time detection](#9022-real-time-detection)
  - [10. knowledge Mining](#10-knowledge-mining)
  - [10.1. Azure Cognitive Search](#101-azure-cognitive-search)
    - [10.1.1. Indexes](#1011-indexes)
  - [10.1.2. Knowledge Store](#1012-knowledge-store)
