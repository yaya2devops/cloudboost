...
# Table of contents
 [Core Fundamental Concepts](#Core-Fundamental-Concepts)
 [Core Azure Services](#Core-Azure-Services)
    1- [Compute]( #Compute)
    2- [Networking](#Netoworking)
    3- [Storage](#Storage)
    4- [Database](#Database)
    5- [Big Data and Analytics](#Big-Data-and-Analytics)
 [Core Solutions](#Core-Solutions)
    1- [IOT]( #Internet-Of-Things-IOT )
    2- [AI]( #artificial-intelligence-ai  )
    3- [Serverless](#Azure-Serverless)
    4- [Azrue DevOps, Github & DevTest Lab](#Tools-for-Better-Solutions)
    5- [Config Tools](#Tools-for-Configurations-and-Management)
...
[Government](#Government)
 [Cost Management](#Cost-Management)  
      1- [Factors]( #Factors )
      2- [Minimize Total Cost](#Minimize-Total-Cost )
